        ...
        <div className='flex-1'>
          ...
          {isEditing ? (
            <>
              ...
              <div className='flex justify-end gap-2 text-2'>
          ...
          <>
            ...
            <div className='flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2'>
              ...
              {currentUser && (currentUser._id === comment.userId || currentUser.isAdmin) && (
                <>
                  <button type='button' className='text-gray-500 hover:text-blue-500' onClick={handleShowEdit}>
                    Edit
                  </button>
                  <button type='button' className='text-gray-500 hover:text-blue-500' onClick={()=>{handleDelete(comment._id)}}>
                    delete
                  </button>
                </>
              )}
